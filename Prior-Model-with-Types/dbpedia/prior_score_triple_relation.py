...
[relation_head_type_set, relation_tail_type_set] = pickle.load(open('./precessed_results/train_relation_htset_v2_thres10.pkl','rb'))
entity_type_set = pickle.load(open("./precessed_results/entity_type_set_v2.pkl","rb"))

seen_triples = pickle.load(open("./precessed_results/train_triples.pkl","rb"))
input_path = './data/db_insnet_test.txt'
triple_score = {}
triple_rank = []
triple_triples = []
hits = []
...
with open(input_path) as f:
    for i, line in enumerate(f.readlines()):
        ...
        if r_gt in relation_list:
            ...
            score = -999*np.ones(len(relation_list))
...
f = open("test_prior_v2_thres10.pkl", 'wb')
